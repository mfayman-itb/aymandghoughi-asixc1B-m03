...
M03 UF1
05/10/2023
Descripció: programa que demani a l’usuari, la quantitat de monedes que tenim
dels següents tipus: 2 €, 1 €, 50 cèntims, 20 cèntims,10 cèntims i 5 cèntims.
...
try:
    ...
    twenty_cents = int(input("How many twenty cents coins do you have? "))
